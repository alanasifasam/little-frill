namespace Application.Models.SiteInfo;

// Sem FromEntity: é montado a partir de duas fontes diferentes
// (ConfiguracaoSite + ConfiguracaoNegocio) e de IEnvioPolicy, não de uma
// única entidade — ver SiteInfoService.ObterAsync.
public class SiteInfoViewModel
{
    public string Titulo { get; set; } = string.Empty;
    public string Gancho { get; set; } = string.Empty;
    public decimal EnvioCustoPadrao { get; set; }
    public decimal EnvioLimiarGratis { get; set; }
    public bool FeriasLigadas { get; set; }
    public List<string> SeccoesAtivas { get; set; } = new();
